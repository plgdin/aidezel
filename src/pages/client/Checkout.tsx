...
const Checkout: React.FC = () => {
  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Insert Order Items AND Reduce Stock safely
      for (const item of cartItems) {
        ...
        // B. ✅ ATOMIC UPDATE via RPC (Prevents Race Conditions & Double Counting)
        // This replaces the old manual "Fetch -> Calculate -> Update" block.
        ...
        if (stockError) {
           // We log the error but allow the order to succeed since payment/order is already recorded.
           // You might want to alert an admin here in a real app.
